...
const IntroInfo = () => {
  return (
    <div className={styles["info-side"]}>
      ...
      {/* ── title block ── */}
      <div className={styles["intro-header"]}>
        <p className={styles["intro-eyebrow"]}>
        ...
        <p className={styles["intro-description"]}>
          Shipped Azerbaijan&apos;s{" "}
          <strong>first digital property insurance platform</strong> at PASHA
          Insurance, built a full e-commerce ecosystem at Machinarium — OMS,
          CMS, PIM, ECOM and admin tools — and delivered client projects across
          a digital agency. Clean code, scalable architecture, high engineering
          standards.
        </p>
